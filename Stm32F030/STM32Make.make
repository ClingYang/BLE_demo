...
my_lib/device_control/device_control.c
...
GCC_PATH="D:/ARMTOOLCHAINCMAKE/ARM-GNU-TOOLCHAIN-13.3.REL1/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"D:/ARMTOOLCHAINCMAKE/OPENOCD-20240916-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"D:/ARMTOOLCHAINCMAKE/OPENOCD-20240916-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f0x mass_erase 0; exit"
